...
function rowToLead(r: any): Lead {
  return {
    ...
    closedDate: r.closed_date || "", closedBySalesRep: r.closed_by_sales_rep || "", bookingConfirmedDate: r.booking_confirmed_date || "",
    depositRequired: !!r.deposit_required, depositCollected: !!r.deposit_collected, depositAmount: Number(r.deposit_amount) || 0,
    depositPaymentMethod: r.deposit_payment_method || "", depositReference: r.deposit_reference || "", depositCollectedDate: r.deposit_collected_date || "",
    depositStatus: (r.deposit_status || "Not Required") as Lead["depositStatus"], proposalSentDate: r.proposal_sent_date || "", quoteSentDate: r.quote_sent_date || "",
  };
}
function leadToRow(l: Partial<Lead>): any {
  return {
    ...
    closed_date: l.closedDate || "", closed_by_sales_rep: l.closedBySalesRep || "", booking_confirmed_date: l.bookingConfirmedDate || "",
    deposit_required: !!l.depositRequired, deposit_collected: !!l.depositCollected, deposit_amount: l.depositAmount || 0,
    deposit_payment_method: l.depositPaymentMethod || "", deposit_reference: l.depositReference || "", deposit_collected_date: l.depositCollectedDate || "",
    deposit_status: l.depositStatus || "Not Required", proposal_sent_date: l.proposalSentDate || "", quote_sent_date: l.quoteSentDate || "",
  };
}
